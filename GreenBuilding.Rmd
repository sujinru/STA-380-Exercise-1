...
Therefore, the annual extra revenue from green rating is ($2.2-$1.5) $\times$ 92.9% $\times$ 250,000 (size) = $162,757 and it needs $5,000,000 /  $162,757 = 30 years to recuperate the extra cost. 30 years as the payback period of an investment is too long and makes the company exposed to risks. We would suggest not building the green building.